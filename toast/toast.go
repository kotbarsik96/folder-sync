// исправленная версия gopkg.in/toast.v1:
// deprecated ioutil.WriteFile заменён на os.WriteFile, т.к. в старой версии некорректно отрабатывалась кодировка кириллических символов
package toast
...
func invokeToastScript(content string) error {
	file := filepath.Join(os.TempDir(), "foldersync_toast.ps1")
